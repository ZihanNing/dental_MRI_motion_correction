...
%ENERGYTAYLOR  Computes the energy of a solution of a least squares 
%problem with different regularisers for the Taylor model of pose-dependent B0 variations. 
