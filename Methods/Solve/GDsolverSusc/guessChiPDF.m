...
N=cast(N, type);
FOV=cast(FOV, type);
[kx, ky, kz] = linearTerms(NKernel(1:3), NKernel(1:3)/2./FOV);%*N/2 to compensate for scaling in linearTerms.m and ./FOV to account for anisotropy
...
H = buildFilter(NKernel(1:3),'tukeyIso',filt.sp,gpu,filt.gibs);
