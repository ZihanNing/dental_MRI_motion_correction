...
if ~isfield(rec.Alg.parXT,'fractionOrder');rec.Alg.parXT.fractionOrder=1;end%Order for fractional derivative-based motion estimation % ZN: enable (=1) it to enable SubDiv, defualt value = 0
...
if ~isfield(rec.Dyn,'Log');rec.Dyn.Log=1;end%To log the command window to a .txt file
