function G=transform3DSincHessian(xB,GB,GC,et,etg,eth,mH,F,FH)

%TRANSFORM3DSINCHESSIAN computes the Hessian of the rigid transform
%   G=TRANSFORM3DSINCHESSIAN(XB,GB,GC,ET,ETG,ETH,MH,{F},{FH}) obtains the
...
if nargin<9 || isempty(F);F={[],[],[]};end
if nargin<10 || isempty(FH);FH={[],[],[]};end
