function [G,GB,GC]=transform3DSincGradient(xB,et,etg,full,F,FH)

%TRANSFORM3DSINCGRADIENT computes the gradient of the rigid transform
%   [G,GB,GC]=TRANSFORM3DSINCGRADIENT(xB,ET,ETG,FULL,{F},{FH}) obtains the
...
if nargin<6 || isempty(F);F={[],[],[]};end
if nargin<7 || isempty(FH);FH={[],[],[]};end
