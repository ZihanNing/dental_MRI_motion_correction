...
function [rec, TW] = dat2Rec_CAIPI(fileName, supportReadout, writeNIIFlag, writeRAWFlag, pathOu, isPilotTone, ...
...
if isfolder(fileName)
    ...
    for i=1:length(Names)
        ...
        dat2Rec_CAIPI(fileNameTemp, supportReadout, writeNIIFlag, writeRAWFlag, pathOu, isPilotTone, removeOversampling, noiseName, resRec,removeZeroSamples,targetR,logFlag,suff);
    end
    ...
    if 0 %isfield(TW.hdr.Meas,'tScanningSequence') && strcmp(TW.hdr.Meas.tScanningSequence,'SE')
        ...
        rec = TWIX2rec_CAIPI(TW, supportReadout, isPilotTone, [], removeOversampling, noiseName, fullfile(pathOu,file), resRec,[], removeZeroSamples, targetR);        
    end
    rec.Names.Name=file;
