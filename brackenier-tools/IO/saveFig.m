...
%SAVEFIG is a wrapper function to save a generated figure with additional options.
%Code relies on https://www.mathworks.com/matlabcentral/fileexchange/23629-export_fig.
%
...
if suppressWarning; warning(warnStruct);end%Set original warning settings
