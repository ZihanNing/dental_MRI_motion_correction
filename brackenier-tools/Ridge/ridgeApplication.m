function [x, P]=ridgeApplication(x,dims,up, P)
...
%Need to take out the phase of the first element of the Fourier harmonics -
%needed as upsampling might result in first element not zero phase and this
