...
function rec=solveSensit7T_noresignresol(rec, recB)
...
rec.Alg.parS.nItVARIATI=0;%Number of iterations of variational refinements % default = 2; ZN debug, disable the first guess of sensitivity
...
rec.Alg.parE.NC=1.5*ones(1,3); % ZN debug, with lucilio's parameter
...
rec.Alg.parE.subSp=1.5*ones(1,3);% ZN debug, with lucilio's parameter
